...
//
//  SPI_MOSI = 1;                                      // Reset the MOSI data line
//	SPIData = 0;
...
static void power_on (void)
{
     ...
     */
    ROM_GPIOPadConfigSet(SDC_SSI_RX_GPIO_PORT_BASE, SDC_SSI_RX, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD_WPU);
    ROM_GPIOPadConfigSet(SDC_SSI_CLK_GPIO_PORT_BASE, SDC_SSI_CLK, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD);
    ROM_GPIOPadConfigSet(SDC_SSI_TX_GPIO_PORT_BASE, SDC_SSI_TX, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD);
    ROM_GPIOPadConfigSet(SDC_SSI_FSS_GPIO_PORT_BASE, SDC_SSI_FSS, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_STD);

    /* Configure the SSI3 port */
    ROM_SSIConfigSetExpClk(SDC_SSI_BASE, g_ui32SysClock, SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, 400000, 8);
...
static void set_max_speed(void)
{
    ...
    ROM_SSIConfigSetExpClk(SDC_SSI_BASE, g_ui32SysClock, SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, i, 8);
